...
static constexpr color RED(0xAA, 0x18, 0x03);
static constexpr color ORANGE(0xBD, 0x61, 0x3C);
static constexpr color YELLOW(0xFF, 0xFF, 0x00);
static constexpr color DARK_GREEN(0x6D, 0x8C, 0x00);
static constexpr color CYAN(0x00, 0xFF, 0xFF);
static constexpr color BLUE(0x2C, 0x4E, 0x80);
...
static constexpr color GREEN(0xBC, 0xAF, 0x4D);
